...
const agents=[
  {id:'positions',title:'תכנון משרות',desc:'ניהול משרות, תקנים, פערים וגיוס מורים',icon:_s('<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>'),ready:true},
  {id:'calendar',title:'תכנון שנתי',desc:'לוח שנה, אירועים ומערכת שעות',icon:_s('<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>','#3B82F6'),ready:true},
  {id:'curriculum',title:'תכנון פדגוגי',desc:'שיבוץ מורים, דשבורד וכרטיסי מורים',icon:_s('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>','#8B5CF6'),ready:true},
  {id:'tasks',title:'ניהול משימות',desc:'מעקב משימות, תזכורות ותעדוף עבודה',icon:_s('<polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>','var(--success)'),ready:true},
  {id:'strategy',title:'תוכנית אסטרטגית',desc:'חזון, ייעוד, ניתוח מצב, יעדים ותוכנית פעולה',icon:_s('<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>','#EC4899'),ready:true},
  {id:'dimensions',title:'חמשת הממדים',desc:'מעקב אחרי יישום הממדים בכל שכבה',icon:_s('<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>','#F59E0B'),ready:false},
  {id:'skills',title:'מיומנויות',desc:'מעקב מיומנויות תלמידים ודוחות',icon:_s('<path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><circle cx="12" cy="12" r="10"/><path d="M12 17h.01"/>','#6366F1'),ready:true,url:'skills.html'},
  {id:'handbook',title:'ספר בית הספר',desc:'נהלים, כללים ומענה לשאלות',icon:_s('<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>','#14B8A6'),ready:true},
  {id:'admission',title:'קבלת תלמידים',desc:'לידים, ראיון, קליטה ותיק תלמיד',icon:_s('<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>','#10B981'),ready:true,url:'student-admission.html'},
  {id:'student-portfolio',title:'תיק תלמיד דיגיטלי',desc:'198 תלמידים — פרטים, ציונים, תח"י, דוחות יועצת, הערות צוות',icon:_s('<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><path d="M12 6v7"/><path d="M9 10l3 3 3-3"/>','#7AADAD'),ready:true,url:'student-portfolio.html'},
  {id:'alerts',title:'תלמידים בסיכון',desc:'זיהוי והתראות על תלמידים בסיכון',icon:_s('<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>','var(--danger)'),ready:false},
  {id:'marketing',title:'שיווק',desc:'תוכן שיווקי וגיוס תלמידים',icon:_s('<path d="m3 11 18-5v12L3 13v-2z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/>','#F97316'),ready:false},
  {id:'jobboard',title:'פרסום משרות',desc:'מודעות גיוס, ניהול משרות פתוחות ודף ציבורי',icon:_s('<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>','#0EA5E9'),ready:true},
  {id:'employment',title:'תעסוקה',desc:'מעסיקים, שיבוצים, נוכחות, טפסים, ביקורים, מכתבי תודה',icon:_s('<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>','#D4A574'),ready:true,url:'employment.html'},
  {id:'bnot-sherut',title:'בנות שירות',desc:'שיבוץ, מעקב נוכחות, הערכות, משימות',icon:_s('<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>','#C9A0A0'),ready:true,url:'bnot-sherut.html'},
  {id:'conversations',title:'שיחות אישיות',desc:'תיעוד שיחות 1:1 עם תלמידים, מעקב יעדים וממדים',icon:_s('<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>','#7B6AAF'),ready:true,url:'personal-conversations.html'},
  {id:'student-feedback',title:'שיחות יחד',desc:'משוב משותף מורה-תלמיד על 9 תחומים: ממדים, נוכחות, תפקוד, מטרות',icon:_s('<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>','#7AADAD'),ready:true,url:'student-feedback.html'},
  {id:'mornings',title:'פתיחות בוקר',desc:'שיבוצים, תיעוד, בנק רעיונות לצוות וחוברת שנתית',icon:_s('<circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/>','#E8A838'),ready:true,url:'morning-opening.html'},
  {id:'monthly-reports',title:'דוחות חודשיים',desc:'דוח מחנך (5 סקאלות דירוג), דוח יועצת, ביקורי בית, דשבורד מנהלת',icon:_s('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 15l2 2 4-4"/>','#7B6AAF'),ready:true,url:'monthly-reports.html'},
];
...
function showPage(id){
  ...
  const labels={dashboard:'דשבורד',positions:'תכנון משרות',calendar:'תכנון שנתי',curriculum:'תכנון פדגוגי',tasks:'משימות',strategy:'אסטרטגיה',stratreport:'דוח אסטרטגי',handbook:'ספר בית הספר',jobboard:'פרסום משרות'};
...
function renderDashboard(){
  ...
  g.innerHTML=agents.map(a=>`
    <div class="agent-card${a.ready?'':' disabled'}" onclick="${a.ready?(a.url?`window.open('${a.url||''}','_blank')`:`showPage('${a.id}')`):''}">
  ...
  // Update hero stats
  try{
    document.getElementById('hs-teachers').textContent=TEACHER_LIST.length;
    let totalH=0;CLASS_LIST.forEach(c=>totalH+=classEffectiveHours(c));
    document.getElementById('hs-hours').textContent=totalH||'—';
    document.getElementById('hs-events').textContent=calEvents.length;
    document.getElementById('hs-tasks').textContent=tasks.filter(t=>t.status!=='done').length;
  }catch(e){}
}
