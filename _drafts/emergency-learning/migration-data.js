...
window.MIGRATION = {
  ...
  screens: [
    ...
    { f:'student-videos.html',      layer:'learning', register:'content', status:'fail', tok:1,comp:1,loc:0,grad:1,btn:0, failNote:'כפתור טורקיז: .player .to-text button משתמש ב-background:var(--brand). כלל 3/4 — פעולה בשכבת למידה = דיו. החלף ל-var(--action). (השאר תקין: חוט/נקודות-התקדמות/הילת-פוקוס לגיטימיים.)' },
    ...
    { f:'world-board.html',     layer:'shell', register:'ops',  status:'fail', tok:0,comp:0,loc:1,grad:0,btn:0, failNote:'אימוג\'י ציורי ב-chips מיוצרים ב-JS: ⛔ (.rchip.block, ש\' 261) ו-⚠ (.rchip.col, ש\' 264). כלל 8 — אימוג\'י→SVG. שים לב ש-.rchip.ok כבר משתמש ב-● טיפוגרפי; ליישר את שני האחרים לגליף/SVG. (שאר הקובץ תקין: טוקנים, אפס hex/גרדיאנט, פס-זהות, data-layer.)' },
