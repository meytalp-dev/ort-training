...
window.MIGRATION = {
  ...
  screens: [
    ...
    { f:'admin-roles-settings.html',layer:'shell', register:'form',    status:'fail', tok:1,comp:1,loc:0,grad:0,btn:1, failNote:'§4 נותר שבב טורקיז אחד — .lock-tag (תג נעילת-מדיניות, שורות 156-159): color:var(--brand-deep) + background:var(--brand-soft) + border:var(--brand-line) → נטרל כמו legend__swatch--lock: color:var(--ink-soft), background:var(--surface-muted), border:var(--line-strong). (4 האלמנטים הקודמים תוקנו נכון.)' },
    ...
    { f:'library.html',             layer:'shell', register:'content', status:'fail', tok:1,comp:1,loc:0,grad:0,btn:0, failNote:'§4 נותר אייקון טורקיז ב-.school-pick svg (בורר בית-ספר, ~שורה 223): color:var(--brand) → var(--ink-soft). (הלוגו הישן+פאביקון כבר תוקנו שיטתית.) הערת-עיצוב: הנקודה של "יחידה" (--brand) ו"סימולציה" (--type-sim) כמעט זהות — לשקול גיוון.' },
