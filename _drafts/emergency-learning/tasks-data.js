...
window.TASKS = [
  ...
  { id:'W0-01', world:0, title:'מסד נתונים משותף', desc:'סכימה אחת לכל התצוגות — בלי כפילות לוגיקה.', cat:'data', phase:'mvpA', status:'doing', file:'data-model.md',
  ...
  { id:'W0-02', world:0, title:'הרשאות RBAC + הפרדת בתי ספר', desc:'מי רואה מה לפי תפקיד וגבול ארגוני.', cat:'flow', phase:'mvpA', status:'doing', file:'roles.html',
  ...
  { id:'W0-03', world:0, title:'Feature Flags — 3 מוצרים', desc:'חירום / שגרה / העשרה נדלקים בנפרד.', cat:'flow', phase:'mvpA', status:'todo', file:'flags-protocol.md',
  ...
  { id:'W0-04', world:0, title:'מצבי מערכת (שגרה/מרחוק/חירום)', desc:'מתג אחד שמשנה כללי הפעלה בכל התצוגות.', cat:'flow', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W0-05', world:0, title:'מודל משך גמיש + DurationPicker', desc:'הריגת "10 דקות" המקובע.', cat:'flow', phase:'mvpA', status:'todo', file:'prd.md',
  ...
  { id:'W0-06', world:0, title:'רכיב Dashboard משותף', desc:'תבנית דשבורד שכל תצוגה ממלאת.', cat:'screen', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W0-07', world:0, title:'מרכז התראות משותף', desc:'התראות + פעולה נדרשת.', cat:'screen', phase:'mvpB', status:'todo', file:'',
    prompt:'בנה/י רכיב מרכז התראות משותף: כל התראה עם טקסט+אייקון+צבע (לא רק צבע) וכפתור פעולה. שימוש חוצה-תצוגות (מורה/מנהל).' },
  { id:'W0-08', world:0, title:'חיפוש חכם משותף', desc:'חיפוש אחיד בכל התצוגות.', cat:'screen', phase:'mvpB', status:'todo', file:'',
  ...
  { id:'W0-D2', world:0, title:'לוגו רֶצֶף + וריאציות', desc:'wordmark + סימן 3 קווים מעוגלים.', cat:'design', phase:'mvpA', status:'doing', file:'',
  ...
  { id:'W0-D3', world:0, title:'מוטיב "קו הרצף" (SequenceLine/Step)', desc:'החתימה הוויזואלית של המערכת.', cat:'design', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W0-D4', world:0, title:'App Shells + ניווט', desc:'Student/Teacher/Principal Shell, Sidebar, Topbar, BottomNav.', cat:'design', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W0-D5', world:0, title:'רכיבי UI בסיס', desc:'Button, Card, Chip, Progress, Modal, Drawer, Toast, Skeleton.', cat:'design', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W0-D6', world:0, title:'ModeSelector + ModeChip', desc:'בורר 3 מצבי מערכת + תג מצב.', cat:'design', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W0-D7', world:0, title:'עמוד Design System חי', desc:'מקור האמת הוויזואלי — 15 מקטעים.', cat:'design', phase:'mvpA', status:'doing', file:'design-system.html',
  ...
  { id:'W0-D8', world:0, title:'טבלאות + Empty States + גרפים', desc:'טבלה 52px, מצב-ריק גאומטרי, גרף קווי נקי.', cat:'design', phase:'mvpB', status:'todo', file:'',
  ...
  { id:'W0-D9', world:0, title:'נגישות WCAG AA (רוחבי)', desc:'focus, מקלדת, aria, ניגודיות, reduced-motion.', cat:'design', phase:'mvpA', status:'todo', file:'',
  ...
  /* --- מינימיזציה ואבטחה --- */
  { id:'W0-S1', world:0, title:'מצב יומי גס — לא מעקב-שניות', desc:'רק פעיל/חלקי/לא נראה.', cat:'security', phase:'mvpA', status:'todo', file:'security-minimization.md',
  ...
  { id:'W0-S2', world:0, title:'check-in מתריע ונמחק', desc:'בלי היסטוריה רגשית על קטין.', cat:'security', phase:'mvpA', status:'todo', file:'security-minimization.md',
  ...
  { id:'W0-S3', world:0, title:'יומן קשר — שדות מובנים בלבד', desc:'בלי הערת טקסט חופשית.', cat:'security', phase:'mvpA', status:'todo', file:'security-minimization.md',
  ...
  { id:'W0-S4', world:0, title:'גבול ארכיטקטוני — בלי AI על נתוני תלמיד', desc:'נתוני קטין לא יוצאים למודל.', cat:'security', phase:'mvpA', status:'todo', file:'security-minimization.md',
  ...
  { id:'W0-S5', world:0, title:'אחסון בישראל + סיווג רמת אבטחה', desc:'בירור מול המשרד.', cat:'security', phase:'mvpA', status:'todo', file:'security-minimization.md',
  ...
  { id:'W0-S6', world:0, title:'אכיפת מצרפיות ארצית בנתונים', desc:'פיקוח ארצי — מספרים, בלי drill לתלמיד.', cat:'security', phase:'mvpB', status:'todo', file:'governance.md',
  ...
  { id:'W0-S7', world:0, title:'Audit Log + מדיניות שמירה/מחיקה', desc:'תיעוד גישה מינימלי + ציות תיקון 13.', cat:'security', phase:'mvpB', status:'todo', file:'privacy.md',
  ...
  /* ===== תצוגה 1 — תלמיד ===== */
  { id:'W1-01', world:1, title:'דף הבית של התלמיד', desc:'"מה יש לי היום" + check-in + הצעד הבא.', cat:'screen', phase:'mvpA', status:'doing', file:'student-home.html',
  ...
  { id:'W1-02', world:1, title:'מסך "המקצועות שלי"', desc:'מקצוע + מיקום ברצף.', cat:'screen', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W1-03', world:1, title:'מסך יחידת למידה (משך גמיש)', desc:'מנה אחת בכל פעם + מסלול הצלה.', cat:'screen', phase:'mvpA', status:'doing', file:'demo-unit-hebrew.html',
  ...
  { id:'W1-04', world:1, title:'מסך "המשימות שלי"', desc:'פתוחות/הוגשו/נצפו + הגשה מהטלפון.', cat:'screen', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W1-05', world:1, title:'מנוע תרגול ובוחן + משוב מיידי', desc:'משוב אחרי כל שאלה, בלי עונש.', cat:'flow', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W1-06', world:1, title:'מסך "ההתקדמות שלי"', desc:'מסלול beads + סיכום שבועי.', cat:'screen', phase:'mvpA', status:'doing', file:'student-home.html',
  ...
  { id:'W1-07', world:1, title:'check-in יומי', desc:'שגרה=מה נלמד; חירום=4 אפשרויות.', cat:'flow', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W1-08', world:1, title:'מרכז הודעות + "המורה ראה"', desc:'הודעות מהמורים + אישור אנושי.', cat:'screen', phase:'mvpA', status:'todo', file:'',
  ...
  /* ===== תצוגה 2 — מורה + מחנך ===== */
  { id:'W2-01', world:2, title:'Dashboard מורה', desc:'הכיתות + "מה דורש אותי היום".', cat:'screen', phase:'mvpA', status:'todo', file:'',
  ...
  { id:'W2-03', world:2, title:'שליחת משימה (< 3 דק\')', desc:'יחידה → כיתה → שליחה מהטלפון.', cat:'flow', phase:'mvpA', status:'doing', file:'teacher-flow.html',
  ...
  { id:'W2-05', world:2, title:'דופק כיתתי (מחנך)', desc:'ירוק/צהוב/אדום לכל תלמיד.', cat:'screen', phase:'mvpA', status:'doing', file:'educator-pulse.html',
  ...
  { id:'W2-06', world:2, title:'יומן קשר + דגלים (מחנך)', desc:'שדות מובנים בלבד + דגלים.', cat:'flow', phase:'mvpA', status:'todo', file:'flags-protocol.md',
    prompt:'בנה/י יומן קשר בשדות מובנים בלבד (ערוץ/תוצאה/משימת המשך — בלי טקסט חופשי, ר\' W0-S3) + דגלים בחירום (flags-protocol.md). אדום → פנייה תוך 24ש\'. גישה מוגבלת.' },
  ...
  { id:'W3-01', world:3, title:'Dashboard מנהל — דופק ביה"ס', desc:'4 KPI + רשימת "נדרש קשר".', cat:'screen', phase:'mvpA', status:'doing', file:'principal-pulse.html',
  ...
  { id:'W3-03', world:3, title:'יידוע הורים (פונקציה)', desc:'הודעה רגועה, בלי אפליקציה.', cat:'flow', phase:'mvpB', status:'todo', file:'parent-weekly.md',
  ...
  { id:'W3-04', world:3, title:'מסך פעילות מורים', desc:'מי מלמד, איפה שקט.', cat:'screen', phase:'mvpB', status:'todo', file:'',
  ...
  { id:'W3-07', world:3, title:'דוחות + דוח יומי לוואטסאפ', desc:'3 מספרים בשעה קבועה.', cat:'integ', phase:'mvpB', status:'todo', file:'daily-report-format.md',
  ...
  { id:'W5-01', world:5, title:'Dashboard ארצי — מצרפי', desc:'מספרים בלבד, בלי drill לתלמיד.', cat:'screen', phase:'later', status:'doing', file:'national-map.html',
  ...
  { id:'W5-02', world:5, title:'מפת בתי הספר', desc:'מצב כל ביה"ס (מצרפי).', cat:'screen', phase:'later', status:'doing', file:'national-map.html',
  ...
  /* ===== תצוגה 7 — קורסי העשרה ===== */
  { id:'W7-01', world:7, title:'קורס העשרה אחד (מקצה לקצה)', desc:'עמוד קורס → שיעור → מעקב.', cat:'screen', phase:'mvpA', status:'todo', file:'',
