...
window.TASKS = [
  ...
  { id:'W0-01', world:0, title:'מסד נתונים משותף', desc:'סכימה אחת לכל התצוגות — בלי כפילות לוגיקה.', cat:'data', phase:'mvpA', status:'todo', file:'data-model.md',
  ...
  { id:'W0-D2', world:0, title:'לוגו רֶצֶף + וריאציות', desc:'wordmark + סימן 3 קווים מעוגלים.', cat:'design', phase:'mvpA', status:'todo', file:'',
