...
window.PRODUCED = {
  ...
  "media-design|6": { n: 12, stage: "built" },
  ...
  "logistics|1": { n: 20, stage: "built" },
  "logistics|3": { n: 23, stage: "built" },
  "logistics|5": { n: 25, stage: "built" },
  "football|4": { n: 10, stage: "built" },
  "football|9": { n: 9, stage: "built" },
  "hebrew|1": { n: 8, stage: "built" },
  "hebrew|3": { n: 7, stage: "built" },
  "hebrew|4": { n: 6, stage: "built" },
  "hebrew|5": { n: 10, stage: "built" },
  "hebrew|6": { n: 7, stage: "built" },
  "hebrew|7": { n: 6, stage: "built" },
  "hebrew|8": { n: 9, stage: "built" },
  "hebrew|9": { n: 6, stage: "built" },
