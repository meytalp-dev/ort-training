...
window.RETZEF=(function(){
  ...
  function buildPrompt(subj,mi){
    ...
    return 'צור יחידות תוכן ל"מדף הרציפות" (רֶצֶף · _drafts/emergency-learning).\n\n'+
      ...
      '• ✍ כתיבה: **אם יש לך גישת-כתיבה לריפו — כן כתוב/י ודחוף/י את היחידות בפועל** (זה רצוי!). ריפו: meytalp-dev/ort-training · ענף main · נתיב מלא: _drafts/emergency-learning/content/'+subj.id+'/module-'+nn+'/ + _manifest.md. קומיט לכל יחידה בעברית. אם אין גישה — הדפס/י בצ\'אט ואמור/אמרי זאת מפורשות.\n'+
