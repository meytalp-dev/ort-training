...
window.RETZEF=(function(){
  ...
  var RED_RULES=[
    ...
    {rx:/חשמל|מתח גבוה|וולט|גז מוגן|גז דליק|לחץ|מנוע|בלמ|קירור|פריאון|מקרר|תרמודינמ/, why:'חשמל/מכני'},
  ...
  function buildPrompt(subj,mi){
    ...
    return 'צור יחידות תוכן ל"מדף הרציפות" (רֶצֶף · _drafts/emergency-learning).\n\n'+
      ...
      '• אל תשתמש/י בכלים/חיבורים ואל תחפש/י קבצים (GitHub/Drive/DOCX). כל מה שצריך נמצא כאן למטה.\n'+
      '• אל תנסה/י לגשת ל-DOCX המקור — הכשירויות המדויקות כבר ברשימה למטה. חסר משהו? כתוב/י [לאימות] והמשך/י.\n'+
      '• עבוד/י יחידה-אחר-יחידה: הפק/י יחידה שלמה, בסוף כתוב/י "— סיום יחידה N · כתבי המשך". אם נגמר המקום — עצור/י וכתוב/י "המשך".\n'+
      ...
      gate+'\n\n'+
      '‼ עקוב/י אחרי ה-DNA (content/unit-dna.md): מבנה, אורך, 3 רמות, תיוג מקור, צ\'ק-DNA. תמצית מחייבת: frontmatter מלא · unit_type=task/assessment · פתיח→הסבר(מנה אחת)→דוגמה→שאלות(2/3/3)→סיכום · ≤40 מילים/מסך · ≤12/משפט · פנייה ניטרלית-מגדרית · בלי אימוג\'ים בגוף.\n'+
      ...
      'מקור (docx · ZIP סל תשפ"ז · פרטי): '+(subj.src||'')+'\n'+
      'פורמט יחידה: כמו content/hebrew/module-05/unit-01-source-reliability.md\n\n'+
      ...
      '4. תיוג סוגי-טעות (EPA) לכל מסיח (content/error-types.md §3).\n'+
      '5. תוצר המודולה → יחידת assessment בסוף.\n'+
      danger+'\n'+
      '7. כתוב ל-content/'+subj.id+'/module-'+nn+'/ + _manifest.md. הסטטוס [לאימות].\n';
  }
