...
window.RETZEF=(function(){
  ...
  function buildPrompt(subj,mi){
    ...
    var danger = subj.danger ?
      ('6. אזור-סכנה: כל קביעה פדגוגית עוברת Perplexity + מקור סמכותי ('+(subj.verify||'משה"ח / אקדמיה ללשון')+'). הרץ verify-pedagogy לפני מסירה.') :
      '6. מגמה מקצועית: נגזר ממסמך המקור בלבד — בלי המצאות. תייג מקור לכל קביעה.';
    var gate;
    ...
    return 'צור יחידות תוכן ל"מדף הרציפות" (רֶצֶף · _drafts/emergency-learning).\n\n'+
      gate+'\n\n'+
      '‼ קרא/י קודם את content/unit-dna.md — ה-DNA המחייב (מבנה, אורך, 3 רמות, תיוג מקור, צ\'ק-DNA).\n'+
      ...
      'הוראות:\n'+
      '1. קרא את מסמך המקור, סעיף 8, מודולה '+pm.n+' — ודא כשירויות מול המקור.\n'+
