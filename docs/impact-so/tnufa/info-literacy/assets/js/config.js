...
const CONFIG = {
  ...
  // 4 כללי הזהב לעבודה עם AI + כלל 0 (רגולציה)
  AI_RULES: [
    { id: 0, name: 'כלים מאושרים בלבד', desc: 'לפי הנחיות משה"ח ינואר 2025: רק כלים מקטלוג מאושר. נדרש אישור הורים.', isRegulation: true },
    { id: 1, name: 'ניסוח קודם', desc: 'לכתוב על דף מה אני שואל.ת ולמה — לפני שפותחים את ה-AI' },
    { id: 2, name: 'שני-מקורות', desc: 'כל פלט AI מאומת מול מקור אנושי לפחות אחד (Lateral Reading — פתח טאב חדש)' },
