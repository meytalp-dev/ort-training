...
// ============================================================
// 🔧 הגדרות שאפשר לשנות בכל זמן (דורש Deploy חדש אחרי שינוי)
// ============================================================
//
// כדי לשנות PIN בעתיד:
//   1. ערוך את הערך כאן (ADMIN_PIN)
//   2. Deploy → Manage deployments → עיפרון → Version: New version → Deploy
//   3. ה-URL לא משתנה, רק הסיסמה תתעדכן
//
const ADMIN_PIN   = '1234';   // ⚠️ ברירת מחדל — להחליף לפני שמעבירים להדר
const HADAR_EMAIL = '';       // ריק = ללא התראות מייל. למלא 'hadar@gmail.com' כדי להפעיל
// ============================================================
