...
{category:"וידאו",name:"HeyGen",link:"https://www.heygen.com",desc:"אווטארים מדברים ודיבוב סרטונים לעברית — סרטוני הסבר והדרכה בלי מצלמה ובלי אולפן.",advantages:["דיבוב וסנכרון שפתיים לעברית","אווטארים מציאותיים","מתאים גם להדרכות ארגוניות ושיווק"],limitations:["מוגבל מאוד בחינם","הגייה בעברית דורשת בדיקה"],hebrew:"חלקי",pricing:"חינמי מוגבל + בתשלום"},
