...
def is_teacher_job(title, description, role_hint=''):
    """מחזיר True רק אם זו משרת מורה אמיתית (לא קו"ח של מורה מחפש עבודה)."""
    text = (title or '') + ' ' + (description or '') + ' ' + (role_hint or '')

    # קו"ח של מורה מחפש עבודה — תמיד לפסול, גם אם בכותרת "מורה ל..."
    cv_patterns = [
    ...
    # החרגות חזקות אחרות (צהרון/מועדונית/וכו')
