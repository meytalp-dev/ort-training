...
function getTimetable_() {
  ...
  // Lesson times
  var lessonTimes = {
    1:'08:30–09:15', 2:'09:15–09:50', 3:'10:00–10:45', 4:'10:55–11:40',
    5:'11:50–12:30', 6:'12:50–13:30', 7:'13:40–14:20'
  };
...
function populateInitialData() {
  ...
  var DATA = {
    'ראשון': {
      'ט1': {1:'חינוך — משה',2:'חינוך — משה',3:'תנ"ך — משה',4:'תנ"ך — משה',5:'הבעה עברית — אופירה',6:'הבעה עברית — אופירה'},
      'ט2': {1:'חינוך — אושר',2:'חינוך — אושר',3:'אזרחות — אושר',4:'אזרחות — אושר',5:'מתמטיקה — אושר',6:'מתמטיקה — אושר'},
      'י1': {1:'חינוך — רעיה',2:'חינוך — רעיה',3:'הבעה עברית — רעיה',4:'הבעה עברית — רעיה',5:'מתמטיקה — נעמה',6:'מתמטיקה — נעמה'},
      'י2': {1:'חינוך — אופירה',2:'כישורי חיים — אופירה ודורית',3:'עברית — מירב',4:'עברית — מירב',5:'אזרחות — משה',6:'חינוך פיננסי — גיא'},
      'י3': {1:'כישורי חיים — פרלה ודורית',2:'חינוך — פרלה',3:'מתמטיקה — ויקי',4:'מתמטיקה — ויקי',5:'עברית — מירב',6:'עברית — מירב'},
      'יא1': {1:'חינוך — יעקב',2:'חינוך — יעקב',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'יא2': {1:'חינוך — נעמה',2:'חינוך — נעמה ומירב',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'יא3': {1:'חינוך — גיא',2:'חינוך — גיא',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'יב1': {1:'כישורי חיים — יוסי וצהי',2:'חינוך — יוסי',3:'מתמטיקה — רווית',4:'מתמטיקה — רווית',5:'ספרות — ויקי ואלה',6:'ספרות — ויקי ואלה'},
      'יב2': {1:'פרטני — יעל',2:'כישורי חיים — יואב וצהי',3:'אזרחות — יואב',4:'אזרחות — יואב',5:'גיא',6:'גיא'},
      'יב3': {1:'מתמטיקה — ויקי',2:'מתמטיקה — ויקי',3:'פרטני — יעל',4:'פרטני — יעל',5:'תנ"ך — יואב',6:'תנ"ך — יואב'}
    },
    'שני': {
      'ט1': {1:'מגמות',2:'מגמות',3:'גיא',4:'מתמטיקה — אושר',5:'כישורי חיים — צהי ומשה',6:'חינוך — משה',7:'היסטוריה — אליאל'},
      'ט2': {1:'מגמות',2:'מגמות',3:'עברית — אושר',4:'גיא',5:'עברית — אושר',6:'מתמטיקה — אושר',7:'אנגלית — יעל'},
      'י1': {1:'הבעה עברית — רעיה',2:'הבעה עברית — רעיה',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות',7:'מבוא לטכנולוגיה — יואב'},
      'י2': {1:'אסטרטגיות למידה — יעל ומשה',2:'אסטרטגיות למידה — יעל ומשה',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'י3': {1:'עברית — אושר',2:'עברית — אושר',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות',7:'מבוא לטכנולוגיה — יואב'},
      'יא1': {1:'מתמטיקה — רווית',2:'מתמטיקה — רווית',3:'תנ"ך — יואב',4:'תנ"ך — יואב',5:'מעגלים — יעל ואפרת',6:'לשון — אפרת',7:'לשון — אפרת'},
      'יא2': {1:'יום תעסוקה'},
      'יא3': {1:'מתמטיקה — ויקי',2:'מתמטיקה — ויקי',3:'לשון — אפרת',4:'לשון — אפרת',5:'תנ"ך — אליאל',6:'תנ"ך — אליאל',7:'מתמטיקה — ויקי'},
      'יב1': {3:'ספרות — ויקי',4:'ספרות — ויקי',5:'תנ"ך — יואב',6:'תנ"ך — יואב'},
      'יב2': {1:'תעסוקה'},
      'יב3': {1:'מתמטיקה — ויקי',2:'מתמטיקה — ויקי',3:'שירלי שחר',4:'שירלי שחר',5:'חינוך — מנו',6:'כישורי חיים — מנו וצהי'}
    },
    'שלישי': {
      'ט1': {1:'תנ"ך — משה',2:'תנ"ך — משה',3:'היסטוריה — אליאל',4:'עברית — מירב',5:'תנ"ך — משה',6:'חינוך פיננסי — גיא'},
      'ט2': {1:'תנ"ך — משה',2:'תנ"ך — משה ומירב',3:'עברית — מירב',4:'היסטוריה — אליאל',5:'תנ"ך — משה',6:'חינוך פיננסי — גיא'},
      'י1': {1:'מגמות',2:'מגמות',3:'הבעה עברית — אופירה',4:'הבעה עברית — אופירה',5:'כישורי חיים — רעיה ודורית',6:'חינוך — רעיה'},
      'י2': {1:'מגמות',2:'מגמות',3:'מתמטיקה — נעמה',4:'מתמטיקה — נעמה',5:'עברית — מירב',6:'עברית — מירב'},
      'י3': {1:'מגמות',2:'מגמות',3:'ספרות — רעיה',4:'ספרות — רעיה',5:'עברית — אושר',6:'עברית — אושר'},
      'יא1': {1:'לשון — אפרת',2:'לשון — אפרת',3:'אנגלית — מריאן ויהודית',4:'אנגלית — מריאן ויהודית',5:'תנ"ך — אליאל',6:'תנ"ך — אליאל'},
      'יא2': {1:'נעמה ומירב',2:'כישורי חיים — ליאת ונעמה',3:'עברית — אושר ומירב',4:'עברית — אושר ומירב',5:'מעגלים — נעמה ויעל',6:'מדעי הטכנולוגיה — יואב'},
      'יא3': {1:'מתמטיקה — ויקי',2:'מתמטיקה — ויקי',3:'אנגלית — מריאן ויהודית',4:'אנגלית — מריאן ויהודית',5:'לשון — אפרת',6:'לשון — אפרת'},
      'יב1': {1:'אנגלית — מריאן ויהודית',2:'אנגלית — מריאן ויהודית',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'יב2': {1:'אזרחות — אושר',2:'מעגלים — יעל ואושר',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'יב3': {1:'אנגלית — מריאן ויהודית',2:'אנגלית — מריאן ויהודית',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'}
    },
    'רביעי': {
      'ט1': {1:'אזרחות — משה',2:'אזרחות — משה',3:'סלטה — משה',4:'סלטה — משה',5:'חינוך פיננסי — גיא',6:'מתמטיקה — נעמה',7:'אנגלית — מריאן'},
      'ט2': {1:'סלטה — אושר',2:'סלטה — אושר',3:'עברית — אושר',4:'עברית — אושר',5:'כישורי חיים — אושר וליאת',6:'מתמטיקה — אושר'},
      'י1': {1:'היסטוריה — רעיה',2:'היסטוריה — רעיה',3:'ספרות — רעיה ומירב',4:'ספרות — רעיה ומירב',5:'חינוך תעבורתי — מנו',6:'חינוך פיננסי — גיא'},
      'י2': {1:'עברית — אופירה',2:'עברית — אופירה',3:'עברית — אופירה',4:'עברית — אופירה',5:'חינוך תעבורתי — מנו',6:'חינוך פיננסי — גיא'},
      'י3': {1:'מתמטיקה — ויקי',2:'מתמטיקה — ויקי',3:'היסטוריה — אליאל',4:'היסטוריה — אליאל',5:'תנ"ך — רעיה',6:'ספרות — רעיה'},
      'יא1': {1:'מתמטיקה — רווית ואפרת',2:'מתמטיקה — רווית ואפרת',3:'אנגלית — מריאן ויהודית',4:'אנגלית — מריאן ויהודית',5:'תנ"ך — אליאל',6:'תנ"ך — אליאל',7:'מתמטיקה — ויקי'},
      'יא2': {1:'עברית — מירב ונעמה',2:'עברית — מירב ונעמה',3:'חינוך תעבורתי — מנו',4:'היסטוריה — גיא',5:'נעמה ויעל'},
      'יא3': {1:'תנ"ך — אליאל',2:'תנ"ך — אליאל',3:'אנגלית — מריאן ויהודית',4:'אנגלית — מריאן ויהודית',5:'מתמטיקה — ויקי',6:'מתמטיקה — ויקי'},
      'יב1': {1:'מתמטיקה — רווית ואפרת',2:'מתמטיקה — רווית ואפרת',3:'מעגלים — יוסי ויעל',4:'מתמטיקה — ויקי',5:'אנגלית — מריאן ויהודית',6:'אנגלית — מריאן ויהודית'},
      'יב2': {1:'מגמות',2:'מגמות',3:'מגמות',4:'מגמות',5:'מגמות',6:'מגמות'},
      'יב3': {1:'שירלי שחר',2:'שירלי שחר',3:'ספרות — ויקי',4:'מעגלים — מנו ויעל',5:'אנגלית — מריאן ויהודית',6:'אנגלית — מריאן ויהודית'}
    },
    'חמישי': {
      'ט1': {1:'אזרחות — משה',2:'אזרחות — משה',3:'תנ"ך — משה',4:'היסטוריה — אליאל',5:'היסטוריה — אליאל',6:'חינוך — משה'},
      'ט2': {1:'אזרחות — משה',2:'אנגלית — מלי',3:'תנ"ך — משה',4:'חינוך פיננסי — גיא',5:'מתמטיקה — נעמה',6:'חינוך — אושר'},
      'י1': {1:'חינוך פיננסי — גיא',2:'חינוך פיננסי — גיא',3:'אנגלית — מלי',4:'חינוך תעבורתי — מנו',5:'מתמטיקה — נעמה',6:'מתמטיקה — נעמה'},
      'י2': {1:'מתמטיקה — נעמה',2:'מתמטיקה — נעמה',3:'חינוך תעבורתי — יוסי',4:'אנגלית — מלי',5:'עברית — מירב',6:'עברית — מירב'},
      'י3': {1:'תנ"ך — יואב',2:'תנ"ך — יואב',3:'חינוך פיננסי — גיא',4:'חינוך תעבורתי — מנו',5:'אנגלית — מלי',6:'אנגלית — מלי'},
      'יא1': {1:'תעסוקה',2:'תעסוקה',3:'תעסוקה',4:'תעסוקה',5:'תעסוקה',6:'תעסוקה'},
      'יא2': {1:'תעסוקה',2:'תעסוקה',3:'תעסוקה',4:'תעסוקה',5:'תעסוקה',6:'תעסוקה'},
      'יא3': {1:'תעסוקה',2:'תעסוקה',3:'תעסוקה',4:'תעסוקה',5:'תעסוקה',6:'תעסוקה'},
      'יב1': {1:'תעסוקה',2:'תעסוקה',3:'תעסוקה',4:'תעסוקה',5:'תעסוקה',6:'תעסוקה'},
      'יב2': {1:'תעסוקה',2:'תעסוקה',3:'תעסוקה',4:'תעסוקה',5:'תעסוקה',6:'תעסוקה'},
      'יב3': {1:'תעסוקה',2:'תעסוקה',3:'תעסוקה',4:'תעסוקה',5:'תעסוקה',6:'תעסוקה'}
    }
  };
  ...
  var TEACHERS = {
    ...
    'אליאל':'#4488AA','שחר':'#7799BB','איילה':'#BB6699'
  };
  var tSheet = ss.getSheetByName('מורים');
  var tRows = [];
